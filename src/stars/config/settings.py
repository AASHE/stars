...
MEDIA_LOCAL = os.environ.get("MEDIA_LOCAL", False)

API_TEST_MODE = os.environ.get("API_TEST_MODE", DEBUG)
FIXTURE_DIRS = [
    "fixtures",
    os.path.join(PROJECT_PATH, "apps/api/fixtures"),
]
...
# Database
DATABASES = {"default": dj_database_url.parse(os.environ.get("STARS_DB_URL", None))}
...
CMS_TEMPLATES = (("cms/article_detail.html", "Article Detail"),)
...
CACHES = {
    "default": django_cache_url.parse(os.environ.get("CACHE_URL", "dummy://")),
...
LOGGING = {
    ...
    "filters": {
        ...
        "request_filter": {"()": "stars.apps.helpers.logging_filters.RequestFilter"},
        "user_filter": {"()": "stars.apps.helpers.logging_filters.UserFilter"},
    },
    "handlers": {
...
if "test" in sys.argv:
    DATABASES["default"] = dj_database_url.parse(
        os.environ.get("STARS_TEST_DB", "sqlite:////tmp/stars_tests.db")
    )

    CACHES = {
        "default": django_cache_url.parse(os.environ.get("CACHE_URL_TEST", "dummy://")),
        "filecache": django_cache_url.parse(
...
SETTINGS_EXPORT = ["STARS_BROCHURE_HOST", "STARS_REPORTS_HOST", "STARS_BENCHMARKS_HOST"]
